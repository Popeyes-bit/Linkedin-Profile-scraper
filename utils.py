...
class Job:
    def __init__(self, position: str, company: Company, location: Location, date_range: str,exp: str):
    ...
    def reprJSON(self):
        return dict(position=self.position, company=self.company, location=self.location, date_range=self.date_range,exp=self.exp)

class Profile:
    def __init__(self, name: str, title: str, image: str, email: str,  about: str, education: str,edu1: str ,edu2: str ,edu3: str ,recommendations:str,skills: [str], jobs: [Job]):
        self.name = name
        self.title=title
        self.image=image
        self.email = email
    ...
    def reprJSON(self):
        return dict(name=self.name,title=self.title, image=self.image, email=self.email, about=self.about, education=self.education,edu1=self.edu1,edu2=self.edu2, edu3=self.edu3,  recommendations=self.recommendations, skills=self.skills, jobs=self.jobs)
