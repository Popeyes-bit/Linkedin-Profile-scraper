...
#sys.argv is an object which looks for arguments passed in the begining of code
...
# Headers
headers = ['Name','Title','ImageLink', 'Email','About','Education','edu1','edu2','edu3','Recommendations' ,'Skills', 'Jobs']
